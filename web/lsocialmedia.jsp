...
<%   
   ...
   if(request.getParameter("DA")!=null)
    {
        ...
        response.sendRedirect("http://localhost:8080/GIL/delete/s.jsp");
   ...
   if(request.getParameter("us")!=null)
    {
     p.updatesocialmediastatus(request.getParameter("n3"),user); 
     f=2;
    }
   if(request.getParameter("rf")!=null)
        {
                rs1=p.getsocialmedia4(user);
                     rs1.next();
       }
    %>
...
<html>
    <head>
        ...
        <title> Social Media Session</title>
    </head>
    <body onload="display1()">
   <h1 align ="center">USER PROFILE</h1>
        <form name="updateform1" action="lsocialmedia.jsp">
            <table border="0">
