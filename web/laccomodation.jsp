...
<%   
   ...
   if(request.getParameter("DA")!=null)
    {
        ...
        response.sendRedirect("http://localhost:8080/GIL/delete/a.jsp");
   ...
   if(request.getParameter("UF")!=null)
    ...
    Timestamp timestamp = new Timestamp(date.getTime()); 
     p.updateaccommodationfact(request.getParameter("n1"),request.getParameter("n2"),request.getParameter("n7"),timestamp,user);
     f=1;
    }
   if(request.getParameter("us")!=null)
    {
     p.updateaccommodationstatus(request.getParameter("n3"),user); 
     f=2;
    }
   if(request.getParameter("rf")!=null)
        {
                rs1=p.getaccommodation4(user);
                     rs1.next();
       }
    %>
...
<html>
    <head>
        ...
        <title>Accommodation Session</title>
    </head>
    <body onload="display1()">
        <h1 align ="center">USER PROFILE</h1>
        <form name="updateform1" action="laccomodation.jsp">
            <table border="0">
