...
<%   
   ...
   if(request.getParameter("DA")!=null)
    {
        response.sendRedirect("http://localhost:8080/GIL/delete/p.jsp"); 
    }
   ...
   if(request.getParameter("UF")!=null)
    ...
    Timestamp timestamp = new Timestamp(date.getTime()); 
     p.updatefact(request.getParameter("n1"),request.getParameter("n2"),request.getParameter("n7"),timestamp,user);
     f=1;
    }
   if(request.getParameter("us")!=null)
    {
     p.updateproneareastatus(request.getParameter("n3"),user);
     f=2;
    }
   if(request.getParameter("rf")!=null)
        {
                rs1=p.getpronearea4(user);
                     rs1.next();
       }
    %>
...
<html>
    <head>
        ...
        <title>Pronearea Session</title>
    </head>
    <body onload="display1()">
      <h1 align ="center">USER PROFILE</h1>
       
        <form name="updateform1" action="lpronearea.jsp">
            <table border="0">
