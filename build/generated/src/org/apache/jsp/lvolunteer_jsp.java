...
import Table.volunteer;
import java.sql.*;
import java.util.Date;

public final class lvolunteer_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 Class.forName("com.mysql.jdbc.Driver"); 
   ...
   if(request.getParameter("UF")!=null)
    ...
    Timestamp timestamp = new Timestamp(date.getTime());  
     v.updatefact(request.getParameter("n1"),request.getParameter("n2"),request.getParameter("n2"),timestamp,user); 
     f=1;
    }
